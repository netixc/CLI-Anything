...
```
source /root/projectx/Agent-Avatar/agent-harness/.venv/bin/activate && cli-anything-agent-avatar speak "Understood. TTS mode active."
```

Example WRONG response (do NOT do this):
```
source /root/projectx/Agent-Avatar/agent-harness/.venv/bin/activate && cli-anything-agent-avatar speak "Done!"
